...
#[uniffi::export]
fn has_external_conflict_marker_remnants(content: String, marker_length: u32) -> bool {
    jayjay_core::external_tools::has_conflict_marker_remnants(&content, marker_length as usize)
}
