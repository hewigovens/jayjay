...
| --- | --- | --- | --- |
| Open a Repository | Yes | Yes | Pins share `repositories.json`; Recent is shell-local. Title menu activates an open window or opens a closed pin without duplicating. |
