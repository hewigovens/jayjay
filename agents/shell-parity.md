...
| Workspaces | Yes | Yes | Create, open, show context, forget. Switching: GPUI status-bar picker; SwiftUI also has palette Switch to — presentation, not a workflow gap. |
...
| GPUI Shell Alpha | N/A | Yes | The guide's GPUI alpha section is the source of truth. Update it with this matrix. |
