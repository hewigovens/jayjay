...
2. Classify at affordance granularity. Confirm implementation and tests before calling anything absent; a row is not a feature-level verdict. Parity covers UX and design as well as features: an affordance that exists but breaks a [Design](../../../agents/design.md#invariants) invariant or buries what the user scans for is a gap.
