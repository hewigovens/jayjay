            ...
            move |_, cx| {
                ...
                cx.new(|cx| {
                    ...
                    cx.observe_global::<crate::app::config::AppConfigStore>(|_, cx| cx.notify())
                        .detach();
                    ExternalToolWindow::new_with_exit_state(invocation.clone(), exit_state, cx)
                })
            },
        )
