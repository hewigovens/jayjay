...
struct DAGRow: View {
    ...
    private func rowBody(wiggleAngle: Double) -> some View {
        rowContent
            ...
            .overlay { rebaseOutline }
            .overlay(alignment: .top) { rebaseBeforeGuide }
            .overlay(alignment: .bottom) { rebaseAfterGuide }
            .overlay(alignment: .trailing) { dragTargetBubbleOverlay }
    }
